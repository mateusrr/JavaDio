...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cliente mateus = new Cliente("Mateus", bancoInicial);  //criado novo cliente carla
        mateus.setNome("Mateus Rocha"); //insere o nome do cliente

        Conta ccorrente = new ContaCorrente(mateus); //instanciada nova conta corrente
